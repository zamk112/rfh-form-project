...
import type { IInputProp, ISelectProp, IFormResultsProp } from "../Interfaces/IFormComponentsProps";
import type { IReactSelectComponentProp, IOptionType, IReactSelectGroupedComponentProp, IReactSelectGroupProp } from "../Interfaces/IReactSelectComponentProps";
import type { TFormInput } from "../Types/TFormProps";
import { formattedDateTimeLongNow } from "../Utilities/DtHelpers";
import { FormComponent, InputComponentWithError, InputComponent, SelectComponentWithError, SelectComponent } from "../Components/FormComponents";
import { FormResultComponent } from "../Components/FormResultComponents";
import { ReactSelectComponentWithError, ReactSelectComponent } from "../Components/ReactSelectComponent";

const SyncFormPage = (): JSX.Element => {
    ...
    const favPets: ISelectProp = {
        ...
        options: [
            ...
            {
                optGroup: "Flying pets",
                iSelectOptions: [{ value: "parrot", label: "Parrot" }],
            },
        ],
    };
    ...
    const favProgFramework: IReactSelectGroupedComponentProp<
        IOptionType,
        IReactSelectGroupProp
    > = {
    ...
    const favGamesGrouped: IReactSelectGroupedComponentProp<
        IOptionType,
        IReactSelectGroupProp
    > = {
        name: "favLibGrouped",
